<a name="readme-top"></a>
<h1 align='center'> Penny Pincher 🪙 </h1>
...
# 🥙 Penny Pincher <a name="about-project"></a>
...
```sh
  cd my-folder
  git clone git@github.com:PrantoshB/Penny-Pincher.git
```
...
Feel free to check the [issues page](https://github.com/PrantoshB/Penny-Pincher/issues).
